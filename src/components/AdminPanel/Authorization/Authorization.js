...
export default function Authorization() {
  return (
    <div className='authorization'>
      <span className='authorization__heading'><span className='logo'></span> <h2 className='authorization__heading__head'>Need for drive</h2></span>
      <div className='authorization__login-block'>
        ...
        <form className='authorization__login-block__form'>
          ...
          <span className='authorization__login-block__form__buttons-block'><a className='link' href='#'>
            Запросить доступ
          </a>
